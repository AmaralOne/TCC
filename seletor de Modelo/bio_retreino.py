...
for serie in index:
    ...
    result_series = pd.read_excel('D:\\TCC\\seletor de Modelo\\Result_bio\\Resultado_2Predict'+str(serie)+'.xlsx',None)
    ...
    writer = pd.ExcelWriter('Result_bio_Retreino\Resultado_Predict_retreino2_'+str(serie)+'.xlsx', engine='xlsxwriter')
