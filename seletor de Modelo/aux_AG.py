...
def avaliacao():
        ...
        if cromossomo[tamanho_cromossomo-2] == '0' and cromossomo[tamanho_cromossomo-1] == '0':
            print("Media")
            result_comb = ensembles_strategist.Mean_Combination(ts,len(testData),methods_selecionados,results)
        elif cromossomo[tamanho_cromossomo-2] == '0' and cromossomo[tamanho_cromossomo-1] == '1':
            result_comb = ensembles_strategist.Median_Combination(ts,len(testData),methods_selecionados,results)
            print("Mediana")
        elif cromossomo[tamanho_cromossomo-2] == '1' and cromossomo[tamanho_cromossomo-1] == '0':
            result_comb = ensembles_strategist.Trimmed_Mean_Combination(ts,len(testData),methods_selecionados,results)
            print("Media Aparada")
        elif cromossomo[tamanho_cromossomo-2] == '1' and cromossomo[tamanho_cromossomo-1] == '1':
